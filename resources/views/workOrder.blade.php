...
<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1>
					<span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Preglej delovni nalog
				</h1>
			</div>
			<div class="col-md-2">
			</div>
					...
					@if (!empty($workOrder))
						<div class="row">
							<div class="col-md-6 form-group">
								...
								<div class="col-md-6 form-group">
							<b>Izdan:</b> {{ $workOrder->created_at }}
						</div>
						</div>
						<div class="row">
							<div class="col-md-6 form-group">
								<b>Izdal:</b> {{ $workOrder->prescriber }}
							</div>
							<div class="col-md-6 form-group">
								<b>Prevzel:</b> {{ $workOrder->performer }}
							</div>
						</div>
					@endif
						</div>
